...
var life = new LifeUniverse()

var drawer = new LifeCanvasDrawer()
...
window.onload = function () {
  ...
  function init_ui () {
    ...
    $('settings_submit').onclick = function () {
      ...
      if (isNaN(drawer.border_width) || drawer.border_width < 0 || drawer.border_width > 0.5) {
      ...
      if (false) {
        ...
        http_get(pattern_path + 'list', function (text) {
          ...
          patterns.forEach(function (pattern) {
            ...
            var size = pattern.split(' ')[1]

            var name_element = document.createElement('div')

            var size_element = document.createElement('span')
