...
function parse_rle (pattern_string) {
  ...
  var field_x = new Int32Array(initial_size)

  var field_y = new Int32Array(initial_size)

  var alive_count = 0

  var len = pattern_string.length
...
function parse_rule (rule_str, survived) {
  ...
  var parsed = rule_str.split('/')[survived ? 0 : 1]
