...
LifeUniverse.prototype.get_root_bounds = function () {
  ...
  var offset = this.pow2(this.root.level - 1)
...
LifeUniverse.prototype.make_center = function (field_x, field_y, bounds) {
  ...
  var offset_y = Math.round((bounds.top - bounds.bottom) / 2) - bounds.top
...
LifeUniverse.prototype.setup_meta = function (otca_on, otca_off, field, bounds) {
  ...
  var node = this.field2tree(field, level)
...
LifeUniverse.prototype.node_next_generation = function (node) {
  ...
  var n00 = this.create_tree(nw.nw.se, nw.ne.sw, nw.sw.ne, nw.se.nw)

  var n01 = this.create_tree(nw.ne.se, ne.nw.sw, nw.se.ne, ne.sw.nw)

  var n02 = this.create_tree(ne.nw.se, ne.ne.sw, ne.sw.ne, ne.se.nw)

  var n10 = this.create_tree(nw.sw.se, nw.se.sw, sw.nw.ne, sw.ne.nw)

  var n11 = this.create_tree(nw.se.se, ne.sw.sw, sw.ne.ne, se.nw.nw)

  var n12 = this.create_tree(ne.sw.se, ne.se.sw, se.nw.ne, se.ne.nw)

  var n20 = this.create_tree(sw.nw.se, sw.ne.sw, sw.sw.ne, sw.se.nw)

  var n21 = this.create_tree(sw.ne.se, se.nw.sw, sw.se.ne, se.sw.nw)

  var n22 = this.create_tree(se.nw.se, se.ne.sw, se.sw.ne, se.se.nw)
...
LifeUniverse.prototype.node_quick_next_generation = function (node) {
  ...
  var n00 = this.node_quick_next_generation(nw)

  var n01 = this.node_quick_next_generation(this.create_tree(nw.ne, ne.nw, nw.se, ne.sw))

  var n02 = this.node_quick_next_generation(ne)

  var n10 = this.node_quick_next_generation(this.create_tree(nw.sw, nw.se, sw.nw, sw.ne))

  var n11 = this.node_quick_next_generation(this.create_tree(nw.se, ne.sw, sw.ne, se.nw))

  var n12 = this.node_quick_next_generation(this.create_tree(ne.sw, ne.se, se.nw, se.ne))

  var n20 = this.node_quick_next_generation(sw)

  var n21 = this.node_quick_next_generation(this.create_tree(sw.ne, se.nw, sw.se, se.sw))

  var n22 = this.node_quick_next_generation(se)
...
LifeUniverse.prototype.node_get_boundary = function (
  node,
  left,
  top,
  find_mask,
  ...
  if (node.level === 0) {
    ...
    var find_sw = find_mask

    var find_ne = find_mask

    var find_se = find_mask
